...
>>> from imgaug2.mlx.pooling import avg_pool, max_pool, min_pool  # xdoctest: +SKIP
>>> img = np.random.randint(0, 255, (100, 100, 3), dtype=np.uint8)  # xdoctest: +SKIP
>>> downsampled = avg_pool(img, block_size=2)  # xdoctest: +SKIP
>>> max_pooled = max_pool(img, block_size=(2, 4))  # xdoctest: +SKIP
"""
