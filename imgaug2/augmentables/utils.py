...
def convert_cbaois_to_kpsois(
    ...
    Parameters
    ----------
    cbaois : list of imgaug2.augmentables.bbs.BoundingBoxesOnImage or list of imgaug2.augmentables.bbs.PolygonsOnImage or list of imgaug2.augmentables.bbs.LineStringsOnImage or imgaug2.augmentables.bbs.BoundingBoxesOnImage or imgaug2.augmentables.bbs.PolygonsOnImage or imgaug2.augmentables.bbs.LineStringsOnImage
        Coordinate-based augmentables to convert, e.g. bounding boxes.

    Returns
    -------
    list of imgaug2.augmentables.kps.KeypointsOnImage or imgaug2.augmentables.kps.KeypointsOnImage
...
def invert_convert_cbaois_to_kpsois_(
    ...
    kpsois : list of imgaug2.augmentables.kps.KeypointsOnImages or imgaug2.augmentables.kps.KeypointsOnImages
        Keypoints to convert back to the types of `cbaois`, i.e. the outputs
        of :func:`convert_cbaois_to_kpsois`.

    Returns
    -------
    list of imgaug2.augmentables.bbs.BoundingBoxesOnImage or list of imgaug2.augmentables.bbs.PolygonsOnImage or list of imgaug2.augmentables.bbs.LineStringsOnImage or imgaug2.augmentables.bbs.BoundingBoxesOnImage or imgaug2.augmentables.bbs.PolygonsOnImage or imgaug2.augmentables.bbs.LineStringsOnImage
