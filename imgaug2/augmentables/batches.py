...
class UnnormalizedBatch:
    ...
    heatmaps : None or (N,H,W,C) ndarray or imgaug2.augmentables.heatmaps.HeatmapsOnImage or iterable of (H,W,C) ndarray or iterable of imgaug2.augmentables.heatmaps.HeatmapsOnImage
    ...
    segmentation_maps : None or (N,H,W) ndarray or imgaug2.augmentables.segmaps.SegmentationMapsOnImage or iterable of (H,W) ndarray or iterable of imgaug2.augmentables.segmaps.SegmentationMapsOnImage
    ...
    keypoints : None or list of (N,K,2) ndarray or tuple of number or imgaug2.augmentables.kps.Keypoint or iterable of (K,2) ndarray or iterable of tuple of number or iterable of imgaug2.augmentables.kps.Keypoint or iterable of imgaug2.augmentables.kps.KeypointOnImage or iterable of iterable of tuple of number or iterable of iterable of imgaug2.augmentables.kps.Keypoint
    ...
    bounding_boxes : None or (N,B,4) ndarray or tuple of number or imgaug2.augmentables.bbs.BoundingBox or imgaug2.augmentables.bbs.BoundingBoxesOnImage or iterable of (B,4) ndarray or iterable of tuple of number or iterable of imgaug2.augmentables.bbs.BoundingBox or iterable of imgaug2.augmentables.bbs.BoundingBoxesOnImage or iterable of iterable of tuple of number or iterable of iterable imgaug2.augmentables.bbs.BoundingBox
    ...
    polygons : None  or (N,#polys,#points,2) ndarray or imgaug2.augmentables.polys.Polygon or imgaug2.augmentables.polys.PolygonsOnImage or iterable of (#polys,#points,2) ndarray or iterable of tuple of number or iterable of imgaug2.augmentables.kps.Keypoint or iterable of imgaug2.augmentables.polys.Polygon or iterable of imgaug2.augmentables.polys.PolygonsOnImage or iterable of iterable of (#points,2) ndarray or iterable of iterable of tuple of number or iterable of iterable of imgaug2.augmentables.kps.Keypoint or iterable of iterable of imgaug2.augmentables.polys.Polygon or iterable of iterable of iterable of tuple of number or iterable of iterable of iterable of tuple of imgaug2.augmentables.kps.Keypoint
    ...
    line_strings : None or (N,#lines,#points,2) ndarray or imgaug2.augmentables.lines.LineString or imgaug2.augmentables.lines.LineStringOnImage or iterable of (#lines,#points,2) ndarray or iterable of tuple of number or iterable of imgaug2.augmentables.kps.Keypoint or iterable of imgaug2.augmentables.lines.LineString or iterable of imgaug2.augmentables.lines.LineStringOnImage or iterable of iterable of (#points,2) ndarray or iterable of iterable of tuple of number or iterable of iterable of imgaug2.augmentables.kps.Keypoint or iterable of iterable of imgaug2.augmentables.polys.LineString or iterable of iterable of iterable of tuple of number or iterable of iterable of iterable of tuple of imgaug2.augmentables.kps.Keypoint
    ...
    def to_normalized_batch(self):
        ...
        Returns
        -------
        imgaug2.augmentables.batches.Batch
    ...
    def fill_from_augmented_normalized_batch_(self, batch_aug_norm):
        ...
        Parameters
        ----------
        batch_aug_norm: imgaug2.augmentables.batches.Batch
            Batch after normalization and augmentation.

        Returns
        -------
        imgaug2.augmentables.batches.UnnormalizedBatch
...
class Batch:
    ...
    heatmaps : None or list of imgaug2.augmentables.heatmaps.HeatmapsOnImage
        The heatmaps to augment.

    segmentation_maps : None or list of imgaug2.augmentables.segmaps.SegmentationMapsOnImage
        The segmentation maps to augment.

    keypoints : None or list of imgaug2.augmentables.kps.KeypointOnImage
        The keypoints to augment.

    bounding_boxes : None or list of imgaug2.augmentables.bbs.BoundingBoxesOnImage
        The bounding boxes to augment.

    polygons : None or list of imgaug2.augmentables.polys.PolygonsOnImage
        The polygons to augment.

    line_strings : None or list of imgaug2.augmentables.lines.LineStringsOnImage
        The line strings to augment.
    ...
    def deepcopy(
        ...
        Parameters
        ----------
        images_unaug : imgaug2.augmentables.batches.DEFAULT or None or (N,H,W,C) ndarray or list of (H,W,C) ndarray
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        images_aug : imgaug2.augmentables.batches.DEFAULT or None or (N,H,W,C) ndarray or list of (H,W,C) ndarray
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        heatmaps_unaug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.heatmaps.HeatmapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        heatmaps_aug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.heatmaps.HeatmapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        segmentation_maps_unaug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.segmaps.SegmentationMapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        segmentation_maps_aug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.segmaps.SegmentationMapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        keypoints_unaug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.kps.KeypointOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        keypoints_aug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.kps.KeypointOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        bounding_boxes_unaug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.bbs.BoundingBoxesOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        bounding_boxes_aug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.bbs.BoundingBoxesOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        polygons_unaug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.polys.PolygonsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        polygons_aug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.polys.PolygonsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        line_strings_unaug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.lines.LineStringsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        line_strings_aug : imgaug2.augmentables.batches.DEFAULT or None or list of imgaug2.augmentables.lines.LineStringsOnImage
            Copies the current attribute value without changes if set to
            ``imgaug2.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.
...
class _BatchInAugmentation:
    ...
    def propagation_hooks_ctx(self, augmenter, hooks, parents):
        ...
        hooks : imgaug2.imgaug2.HooksImages or imgaug2.imgaug2.HooksKeypoints
    ...
    def to_batch(self, batch_before_aug):
        ...
        Parameters
        ----------
        batch_before_aug : imgaug2.augmentables.batches.Batch
