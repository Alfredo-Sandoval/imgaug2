...
def quokka(size=None, extract=None):
    ...
    size : None or float or tuple of int, optional
        ...
        :func:`~imgaug2.imgaug2.imresize_single_image`. Usually expected to be a
        ``tuple`` ``(H, W)``, where ``H`` is the desired height and ``W`` is
        the width. If ``None``, then the image will not be resized.

    extract : None or 'square' or tuple of number or imgaug2.augmentables.bbs.BoundingBox or imgaug2.augmentables.bbs.BoundingBoxesOnImage
...
def quokka_heatmap(size=None, extract=None):
    ...
    ----------
    size : None or float or tuple of int, optional
        See :func:`~imgaug2.imgaug2.quokka`.
...
def quokka_keypoints(size=None, extract=None):
    ...
    extract : None or 'square' or tuple of number or imgaug2.augmentables.bbs.BoundingBox or imgaug2.augmentables.bbs.BoundingBoxesOnImage
        Subarea to extract from the image. See :func:`~imgaug2.imgaug2.quokka`.
